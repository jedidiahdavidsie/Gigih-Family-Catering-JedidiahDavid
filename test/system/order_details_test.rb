...
class OrderDetailsTest < ApplicationSystemTestCase
  ...
  test "should create order detail" do
    ...
    fill_in "Menu item", with: @order_detail.menu_item_id
    fill_in "Order", with: @order_detail.order_id
    fill_in "Portion size", with: @order_detail.portion_size
    fill_in "Total portion price", with: @order_detail.total_portion_price
