...
class MenuCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_category" do
    assert_difference("MenuCategory.count") do
      post menu_categories_url, params: { menu_category: { description: @menu_category.description, name: @menu_category.name } }
    end
  ...
  test "should update menu_category" do
    patch menu_category_url(@menu_category), params: { menu_category: { description: @menu_category.description, name: @menu_category.name } }
